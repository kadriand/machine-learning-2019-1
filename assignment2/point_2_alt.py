...
def point_b():
    ...
    print(f"{a} : {classifier_b(a, loss_lambda)}")
    print(f"{b} : {classifier_b(b, loss_lambda)}")
    print(f"{c} : {classifier_b(c, loss_lambda)}")
...
def point_c():
    ...
    for loss_lambda in loss_lambdas:
        point_classes = [classifier_b(point, loss_lambda) for point in random_points]
